SERVICE = model_analysis_expession
SERVICE_CAPS = model_analysis_expession
SPEC_FILE = model_analysis_expession.spec
URL = https://kbase.us/services/model_analysis_expession
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
