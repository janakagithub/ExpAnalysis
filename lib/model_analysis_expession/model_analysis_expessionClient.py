...
class model_analysis_expession(object):
    ...
    def exp_analysis(self, workspace_name, fbamodel_id, fba_ref, expression_series_ref, expression_cutoff, json_rpc_context = None):
        ...
        resp = self._call('model_analysis_expession.exp_analysis',
                          [workspace_name, fbamodel_id, fba_ref, expression_series_ref, expression_cutoff], json_rpc_context)
        return resp[0]
