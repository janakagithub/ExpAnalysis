package model_analysis_expession::model_analysis_expessionServer;
...
our %return_counts = (
        'exp_analysis' => 1,
        'exp_analysis_async' => 1,
        'exp_analysis_check' => 1,
        'version' => 1,
);

our %method_authentication = (
        'exp_analysis' => 'required',
        'exp_analysis_async' => 'required',
        'exp_analysis_check' => 'required',
);
...
our %async_run_methods = (
        'exp_analysis_async' => 'model_analysis_expession.exp_analysis',
);

our %async_check_methods = (
        'exp_analysis_check' => 'model_analysis_expession.exp_analysis',
);
...
sub call_method {
    ...
    my $ctx = model_analysis_expession::model_analysis_expessionServerContext->new($self->{loggers}->{userlog},
...

{
    ...
    my @result;
    {
        ...
        my $stderr = model_analysis_expession::model_analysis_expessionServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
package model_analysis_expession::model_analysis_expessionServerContext;

use strict;

=head1 NAME

model_analysis_expession::model_analysis_expessionServerContext
...
package model_analysis_expession::model_analysis_expessionServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = model_analysis_expession::model_analysis_expessionServer->new(
